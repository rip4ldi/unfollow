...
# Fixed by risec666
try:
    import requests,uuid,os,sys,ctypes,uuid,time,threading
...
os.system("clear")
print(logo)
print ("\t\33[37;1m[ \33[33;1mLogin Instagram \33[37;1m]\n")
class Login():
    def __init__(self):
        self.username = input("  \33[37;1mUsername :\33[32;1m ")
        self.password = input("  \33[37;1mPassword :\33[32;1m ")
        self.login()
    ...
    def login(self):
        ...
        if "logged_in_user" in res.text:
            ...
            print("\n\t\33[37;1m[ \33[32;1mBerhasil login\33[37;1m ]")
            #input("sessionid : "+ res.cookies['sessionid'])
            Del_following()
        elif "bad_password" in res.text:
            input("\n\t\33[37;1m[ \33[31;1mGagal login\33[37;1m ]\33[37;1m")
            exit(0)
...
def main():
    if os.name == 'nt':
        ctypes.windll.kernel32.SetConsoleTitleW("unfollow tool By risec666")
